...
// 仓库名说明：此项目托管在 GitHub Pages。
// - 若仓库为 <user>.github.io（根站点），base 保持 '/'
// - 若仓库为普通项目仓库（如 ai-news-site），需改为 '/ai-news-site/'
// 用户后续自行 git init + 建仓库时，按实际仓库名修改此处的 base
const BASE = '/kairosAI/'

// 自定义域名时改为你的域名；暂用 GitHub Pages 默认占位
const SITE_HOST = 'https://example.com'
